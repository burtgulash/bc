...
Výstupy programu - jednotlivá pořadí autorů a jejich ocenění jsou uvedeny v
...
Výpočet betweenness je časově nejnáročnější ze všech implementovaných metod. Pro citační síť autorů pro databázi DBLP není exaktní výpočet problém, ale pro rozsáhlou síť databáze CiteSeer byla použita aproximace pro betweenness centrality. Tabulka \ref{btwA} znázorňuje Spearmanovo koeficienty korelace pořadí autorů DBLP mezi exaktním betweenness a aproximovanými, kde velikost množiny vrcholů, kterou uvažujeme ve výpočtu, je postupně $\frac{|V|}{2}, \frac{|V|}{4}, \frac{|V|}{8}, \ldots$.
\begin{table}[!ht]
\begin{center}
\makebox[\linewidth]{
\begin{tabular}{r|l}
