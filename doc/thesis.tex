...
sebe vázáni více než na jiné lidi v tomtéž prostředí~\citet{salkind2008}. Klika
...
Network~\citet{williams2007} nebo Bonacich's
centrality~\citet{hannemanriddle2005}.) je míra vlivu vrcholu v grafu, která
doslova znamená \uv{Důležitý uzel má důležité
sousedy}~\citet{zweigiyengar2010}. Hodnotu vlivu získáme z vlastního vektoru
...
největšímu vlastnímu číslu $\lambda$~\citet{langvillemeyer}.
...
vyhledávače~\citet{pagerankoriginal,visemalseed2005,page1997}. PageRank
...
totožná~\citet{perrafortunato2008}.


\subsection{Closeness centrality}
Closeness neboli \uv{blízkost} je definována jako převrácená hodnota míry
farness, tedy \uv{dalekost}~\citet{sabidussi1966}. Dalekost je součet všech
...
closeness centrality TOPRANK~\citet{closenessapproximation}.
...
prvních $k$ nejvýznamnějších uzlů~\citet{closenessapproximation}.
...
tím mám větší moc}~\citet{hannemanriddle2005}. Betweenness
...
celkovému počtu cest mezi dvěma uzly~\citet{freeman1977,anthonisse1971,brandes2001}.
...
Freemanovi~\citet{freeman1977} a byl původně definován pro neorientované grafy.

\subsubsection{Brandesův algoritmus}
Ve své práci~\citet{brandes2001} Ulrik Brandes zmiňuje (do té doby
...
standardního algoritmu s tímto~\citet{brandes2001}.
...
sobě nalezeno několik metod řešení různými lidmi (Shimbel~\citet{shimbel1955}, Ford~\citet{ford1956}, Dantzig~\citet{dantzig1957}, Bellman~\citet{bellmanford_algorithm}, Moore~\citet{moore1959}, Dijkstra~\citet{dijkstra1959})~\citet{schrijver2012}.
...
nejvýhodnější binární halda~\citet{CLRS,fredmantarjan}. Pro nevážený graf
...
pomocí Bellman-Fordova algoritmu, která v grafu nepozmění nejkratší cesty~\cite{CLRS}.
...
I10-index, R-impact, Wu Index a zejména H-index~\citet{hlwikiaim}, který zde
...
aplikovaný na proměnné s pořadím~\cite{myerswell2002}.  Koeficient korelace
