...
\chapter*{Abstract}
\thispagestyle{empty}
\subsection*{Measuring importance of authors in citation networks}
...
objektivně neměří významnost autora (rozdíl mezi \uv{cituji} u~outdegree
a~\uv{jsem citován} u~ostatních, tj. H-index, indegree, PageRank), u~closeness
